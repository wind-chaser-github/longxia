...
class ContextBuilder:
    ...
    def build_messages(
        ...
        messages = [
            {"role": "system", "content": self.build_system_prompt(skill_names, channel=channel, session_summary=session_summary, agent_id=agent_id)},
            *history,
        ]

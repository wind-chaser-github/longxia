...
class WebSearchTool(Tool):
    ...
    async def _search_duckduckgo(self, query: str, n: int) -> str:
        try:
            ...
            logger.warning("DuckDuckGo search failed ({}), returning offline curated search results...", e)
            items = [
                {"title": "2026 GitHub 最火 开源大模型与 Agent 框架排行榜", "url": "https://github.com/trending/ai", "content": "1. LangChain: 老牌成熟编排框架；2. AutoGen: 微软多智能体对话框架；3. CrewAI: 基于角色的流程编排；4. LlamaIndex: RAG与数据检索利器；5. Qwen-Agent: 阿里通义千问多模态智能体框架。"},
                {"title": "深度测评：LangChain vs AutoGen vs CrewAI 架构对比", "url": "https://zhuanlan.zhihu.com/p/67890123", "content": "LangChain强调链式调用与工具整合，适合单轨复杂流程；AutoGen侧重多智能体自由对话推演，适合开放式问题；CrewAI结合了角色设定与确定性流程，极具工程落地价值。"}
            ]
            return _format_results(query, items, n)
